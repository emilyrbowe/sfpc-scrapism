...
response = requests.get('https://resultmaps.neis-one.org/osm-change-get-tiles?days=' + str(days) + '&bbox=-71.17630004882814,42.27987205109874,-71.04034423828126,42.41065452644085', headers=headers)
...
for feature in data:
    ...
    comments.append(feature["properties"]["tmpstmp"] + "\n\n" + str(feature["properties"]["username"]) + ": \n\n" + str(feature["properties"]["comment"]))
